      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
               <li class="dropdown">
                    <a href="#" class="dropdown-toggle glyphicon glyphicon-bell" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="label label-danger"><?php echo $eventsCount; ?></span></a>
          ...
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Información TMIS</h4>
              </div>
          ...
          <div class="modal-body">
                <div class="col-xs-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="emailTitle" class="form-control" id="emailTitle" placeholder="Título del correo electrónico">
                    </div>  
                  </div>
                </div>
                <div class="col-xs-12">
