<?php
	...
	*/
	class ClientSchedule extends MY_Controller{
		public function __construct(){
			parent::__construct();
			$this->data['meta_title'] = 'TMIS - Conograma';
		...
		public function index ()
		{
			...
			$this->breadcrumbs->push('Cronograma', 'menu/schedule');
			$this->data['breadcrumbs'] = $this->breadcrumbs->show();
			log_message('info', 'mostrando breadcrumbs');
			//Load model Clientes
			$this->load->model("menu/schedule_m");
			log_message('info', 'cargado modelo schedule');
			// Fetch all clients
			$this->data['schedules'] = $this->schedule_m->get_by(array('idUsers'=>$this->session->userdata('idUsers')));
			
			// Load view
			$this->data['subview'] = 'menu/schedule/index';
